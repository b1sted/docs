...
2. **Структура программы, написанной на языке Си**  
...
4. **Понятие о функции. Простейшие средства ввода-вывода**  
...
5. **Примеры простейших программ, написанных на языке Си**  
...
3. **Высокоуровневый файловый ввод-вывод с использованием стандартной библиотеки**  
...
4. **Низкоуровневый интерфейс языка Си**  
...
2. **Операции с двумерными массивами**  
